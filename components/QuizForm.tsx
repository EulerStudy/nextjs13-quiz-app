  ...
  return (
    <div
      ...
      </h1>
      {
        !quizStarted && (
          <div
            className='bg-slate-50 p-6 roundec-xl shaodw'
            >
            ...
            ></SelectState>
            <button
              className='my-4 px-4 py-2 text-white rounded-lg shadow bg-blue-600
              hover:bg-blue-500'
              onClick={startQuiz}
              >
              연습 테스트 시작
          ...
          <div>
            ...
            <div>
              ...
              </div>
              {
                answered && (
                  <button
                    className='my-4 px-8 py-2 text-white float-right 
                    rounded-lg shadow bg-blue-600 hover:bg-blue-500'
      ...
      }
      {
        quizEnded && (
          ...
          >
            ...
            <button
              onClick={newStart}
              className='my-4 px-8 pyu-2 text-white w-full rounded-lg shadow bg-blue-600
              hover:bg-blue-500'
            >
              새로운 연습 테스트를 시작하세요.
            </button>
